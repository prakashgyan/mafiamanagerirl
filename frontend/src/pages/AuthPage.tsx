  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden bg-slate-950">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        {/* Middle-right — indigo */}
        <div className="animate-blob-2 animation-delay-6000 absolute right-[4%] top-[30%] h-40 w-40 rounded-full bg-indigo-500/8 blur-3xl sm:h-64 sm:w-64 lg:h-80 lg:w-80 xl:h-[400px] xl:w-[400px]" />
